...
from dlightrag.ai.providers.base import CompletionProvider

_PROVIDER_CLASSES: dict[str, str] = {
    "openai": "dlightrag.ai.providers.openai_compatible.OpenAICompatibleProvider",
    "anthropic": "dlightrag.ai.providers.anthropic_native.AnthropicProvider",
    "gemini": "dlightrag.ai.providers.gemini_native.GeminiProvider",
}

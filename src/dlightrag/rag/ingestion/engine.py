...
from dlightrag.rag.ingestion.lightrag_sidecar import collect_lightrag_drawing_assets
...
from dlightrag.rag.sourcing.source_contract import local_source_uri, safe_source_filename

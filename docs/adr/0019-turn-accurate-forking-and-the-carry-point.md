...
the Web offers Fork per turn and no per-turn Follow-Up control. The carry and its
refusals are then superseded by
[ADR 0022](0022-session-owned-memory-and-run-owned-products.md): notes are

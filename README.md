...
- **Knowledge graph + vector + visual retrieval** — Multi-strategy retrieval across knowledge graph ([LightRAG](https://github.com/HKUDS/LightRAG)), vector similarity, visual content, and metadata

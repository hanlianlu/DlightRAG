...
- **Knowledge graph + vector + visual retrieval** — Multi-strategy retrieval across knowledge graph, vector similarity, visual content, and metadata — LightRAG at the core
